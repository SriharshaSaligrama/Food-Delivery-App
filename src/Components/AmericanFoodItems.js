...
export const AmericanFoodItems = props => {
    ...
    const FoodArray=vegChecked?vegItems.map(item=>[item.name, item.price, item.img]):AmericanFood.map(item=>[item.name, item.price, item.img])
    ...
    return (
        <div>
            <Navbar bg="light" expand="lg">
                <Container fluid>
                    <Navbar.Brand href="#">American ({searchedItems.length}/{FoodArray.length})</Navbar.Brand>
